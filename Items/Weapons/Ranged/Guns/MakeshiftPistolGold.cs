...
{
    class MakeshiftPistolGold : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Makeshift Gold Pistol");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.damage = 11; // Inital damage with no modifications.
            ...
            item.value = Item.sellPrice(0, 0, 15, 0); // The sell price. In (Platnium, Gold, Silver, Copper).
