...
{
    class MakeshiftPistolIron : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Makeshift Iron Pistol");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.damage = 8; // Inital damage with no modifications.
            ...
            item.useTime = 28;
            item.useAnimation = 28; // UseAnimation and useTime SHOULD match to prevent multiple attacks in one animation unless desired.
            ...
            item.value = Item.sellPrice(0, 0, 3, 5); // The sell price. In (Platnium, Gold, Silver, Copper).
