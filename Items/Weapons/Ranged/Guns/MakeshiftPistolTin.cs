...
{
    class MakeshiftPistolTin : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Makeshift Tin Pistol");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.damage = 7; // Inital damage with no modifications.
            ...
            item.value = Item.sellPrice(0, 0, 1, 15); // The sell price. In (Platnium, Gold, Silver, Copper).
