...
{
    class MakeshiftPistolTungsten : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Makeshift Tungsten Pistol");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.damage = 10; // Inital damage with no modifications.
            ...
            item.useTime = 26;
            item.useAnimation = 26; // UseAnimation and useTime SHOULD match to prevent multiple attacks in one animation unless desired.
            ...
            item.value = Item.sellPrice(0, 0, 11, 25); // The sell price. In (Platnium, Gold, Silver, Copper).
