...
{
    class MakeshiftPistolLead : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Makeshift Lead Pistol");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.value = Item.sellPrice(0, 0, 4, 50); // The sell price. In (Platnium, Gold, Silver, Copper).
