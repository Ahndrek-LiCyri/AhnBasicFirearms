...
{
    class MakeshiftPistolCopper : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Makeshift Copper Pistol");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.damage = 6; // Inital damage with no modifications.
            ...
            item.useTime = 29;
            item.useAnimation = 29; // UseAnimation and useTime SHOULD match to prevent multiple attacks in one animation unless desired.
            ...
            item.value = Item.sellPrice(0, 0, 0, 85); // The sell price. In (Platnium, Gold, Silver, Copper).
