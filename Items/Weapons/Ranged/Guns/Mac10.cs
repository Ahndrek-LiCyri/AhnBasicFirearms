...
namespace AhnBasicFirearms.Items.Weapons.Ranged.Guns
{
    class Mac10 : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("'Not a burger!'");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.damage = 3; // Inital damage with no modifications.
            ...
            item.useTime = 10;
            item.useAnimation = 10; // UseAnimation and useTime SHOULD match to prevent multiple attacks in one animation unless desired.
            ...
            item.value = Item.sellPrice(0, 0, 25, 0); // The sell price. In (Platnium, Gold, Silver, Copper).
        ...
        {
            return new Vector2(-1, 6); // Adjust until gun looks right!
        }

        public override void AddRecipes()
        {
            ModRecipe recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemType<MachinePistol>());
            recipe.AddIngredient(ItemType<SpeedEjector>());
            recipe.AddIngredient(ItemID.GrayStucco, 10);
