...
{
    class MakeshiftPistolPlatinum : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Makeshift Platinum Pistol");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.damage = 13; // Inital damage with no modifications.
            ...
            item.useTime = 25;
            item.useAnimation = 25; // UseAnimation and useTime SHOULD match to prevent multiple attacks in one animation unless desired.
            ...
            item.value = Item.sellPrice(0, 0, 23, 0); // The sell price. In (Platnium, Gold, Silver, Copper).
